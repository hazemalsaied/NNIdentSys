...
class TransitionClassifier(nn.Module):
    ...
    def __init__(self, indices, nb_labels, w_embedding_dim, p_embedding_dim, lstm_hidden_dim, nb_focus_elements,
        ...
        if val_dgs:
            ...
            # early stopping
                ...
                if opt['validation_split'] > 0:
                    ...
                    return train_transition_classifier(depgraphs, indices, transition_parser, config_feats_description,
                                                       opt, logstream)
