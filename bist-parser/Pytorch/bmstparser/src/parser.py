...
if __name__ == '__main__':
    ...
    parser.add_option("--train", dest="conll_train", help="Annotated CONLL train file", metavar="FILE",
                      default=os.path.join(mainP, "data/en-universal-train.conll"))  # .ptb")
    parser.add_option("--dev", dest="conll_dev", help="Annotated CONLL dev file", metavar="FILE",
                      default=os.path.join(mainP, "data/en-universal-dev.conll"))  # .ptb").ptb")
    parser.add_option("--test", dest="conll_test", help="Annotated CONLL test file", metavar="FILE",
                      default=os.path.join(mainP, "data/en-universal-test.conll"))  # .ptb").ptb")
    ...
    parser.add_option("--disablelabels", action="store_false", dest="labelsFlag", default=False)
    ...
    if options.predictFlag:
        ...
        with open(os.path.join(mainP, options.output, options.params), 'w') as paramsfp:
