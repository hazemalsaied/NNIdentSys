...
AuxLabels = ['aux.tps', 'aux.pass', 'aux.caus']
ArgLabels = ['suj', 'obj', 'de_obj', 'a_obj', 'p_obj', 'ats', 'ato']

# pour version 7 : ajouter auraient
GramForms = {'avoir': ['avoir','ai', 'as', 'a', 'avons', 'avez', 'ont', 'avais', 'avait', 'avions', 'aviez', 'avaient', 
                       'aurai', 'auras', 'aura', 'aurons', 'aurez', 'auront', 
                       'eus', 'eut', 'eûmes', 'eûtes', 'eurent', 'aurais', 'aurait', 'aurions', 'auriez', 'auriont' , 'auraient',
...
# list the voice to (surface, canonical) functions pairs
# only for the cases where the canonical function differs from the surface function
Alternations = {
    'pass' : { 'suj' : 'obj',
               'p_obj' :'suj' },
    'pass_impers' : { 'suj' : 'void',
                      'p_obj' : 'suj' },
    'impers' : { 'suj' : 'void',
                 'obj' : 'suj' },
    'middle' : { 'suj' : 'obj' },
    'middle_impers' : { 'suj' : 'void' },
